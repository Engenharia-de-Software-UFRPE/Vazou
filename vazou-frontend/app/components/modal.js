...
export default function Modal ({leftButtonText, rightButtonText, title, setModalClosed, rightButtonAction}){
        ...
        <div className={'modal absolute top-2/4 left-2/4 -translate-x-1/2 -translate-y-1/2 drop-shadow-2xl'}>
            <div className={'modal-content bg-white flex justify-center items-center flex-col px-12 py-8'}> 
                ...
                <div className={'flex justify-end'}> 
                    <Button backgroundColor={"bg-orange-500"} onClickFunction={() => closeModal(setModalClosed)}>
                        {leftButtonText}
                    </Button>
