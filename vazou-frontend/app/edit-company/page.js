            ...
            <div className='flex min-h-screen flex-col w-3/5 mx-auto mt-5'>
                <div className='flex justify-between items-center -mt-20 mb-20 self-center' style={{ minWidth: 650 }}>
                    ...
                    <div className='flex flex-col gap-4 self-center'>
                        ...
                        <div>
                            <button onClick={() => onClickFunction()} className={`m-4 font-poppins w-[109px] h-[41px] rounded text-black bg-yellow-200`}>
                                Editar
                            </button>

                            <button onClick={() => onClickFunction()} className={`m-4 font-poppins w-[109px] h-[41px] rounded text-black bg-red-500`}>
                                Excluir
                            </button>
                        </div>
                    </div>
                ...
                <h2 className="flex flex-col items-center self-start text-orange-500 text-2xl font-extrabold -mb-8 mt-10">
                        Relacionados
                </h2>
                <Enterprise/>
